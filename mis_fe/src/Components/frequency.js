                    ...
                    <div className="gen-section-body">
                        ...
                        <div className="gen-action-row">
                            ...
                            <Button icon="pi pi-file-excel" label="Export Raw Data" className="gen-btn-secondary"
                                ...
                                onClick={() => { window.location.href = `${baseUrl}/GetFrequencyDataExcel?startDate=${moment(start_date).format("YYYY-MM-DD")}&endDate=${moment(end_date).format("YYYY-MM-DD")}&stationName=${(Selected_frequency_states || []).map(s => String(s).replace(/&/g, "%26")).join(",")}`; }} />
