...
.gen-hero {
  ...
  background: linear-gradient(135deg, #1e1b4b 0%, #2563eb 45%, #3b82f6 100%);
...
.gen-section:hover {
  ...
  box-shadow: var(--shadow-hover), 0 0 0 3px rgba(59,130,246,0.07);
}
.gen-section-header {
  padding: 18px 24px;
...
.gen-section-pill.blue   { background: rgba(59,130,246,0.14); color: #3b82f6; border: 1px solid rgba(59,130,246,0.25); }
.gen-section-pill.violet { background: rgba(59,130,246,0.14); color: #2563eb; border: 1px solid rgba(59,130,246,0.25); }
...
.gen-btn-primary {
  background: linear-gradient(135deg, #1e1b4b 0%, #2563eb 50%, #3b82f6 100%) !important;
  border: none !important;
...
/* Download Excel — enabled (#3b82f6) */
.gen-btn-secondary:not(:disabled),
.gen-btn-secondary:not([disabled]) {
  background: linear-gradient(135deg, #1e1b4b 0%, #2563eb 60%, #3b82f6 100%) !important;
  border: none !important;
  color: #fff !important;
  opacity: 1 !important;
...
export default function Isgs() {
    ...
    return (
        <>
            ...
            <div style={{ paddingBottom: 40, '--page-accent': '#3b82f6' }}>
				<div>
