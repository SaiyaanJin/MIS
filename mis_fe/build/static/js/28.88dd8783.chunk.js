		...
		28: function (e, n, t) {
			...
			function x(e) {
				var n = (0, g.F)().isDarkMode,
					...
					r = (0, i.useMemo)(
						function () {
							if (!e.exchange_data) return { chartData: {}, chartOptions: {} };
							for (
								var t =
										e.exchange_data[e.exchange_data.length - 1].Date_Time || [],
									r = (0, m.Jm)(t),
									i = [],
									o = !1,
									l = 0;
								l < e.exchange_data.length - 1;
								l++
							) {
								var s,
									c,
								...
								var b =
									...
									v =
										...
										void 0 === c
											...
											: "N/A",
									y = null != h ? Number(h).toFixed(2) : "N/A";
								i.push({
									label: ""
				...
				(0, i.useEffect)(
					function () {
						if (
							...
							e.length === J.length &&
								s.Z.post("/MultiExchangeNames?MultistartDate=" + e, {})
									.then(function (e) {
										return $(e.data);
									})
									.catch(function () {});
						...
						if (me) {
							...
							n.length === me.length &&
								s.Z.post("/MultiExchangeNames?MultistartDate=" + n, {})
									.then(function (e) {
										return $(e.data);
									})
									.catch(function () {});
							...
							if (p) {
								...
								if (h.length > 0) {
									...
									((x["!cols"] = Object.keys(h[0]).map(function (e) {
										...
										w.utils.book_append_sheet(t, x, "Exchange Data"));
								}
							} else
								...
								children: (0, h.jsxs)("div", {
									...
									children: [
										...
										(0, h.jsx)("div", {
											...
											children: "Fetching Exchange Data",
										}),
										(0, h.jsx)("div", {
												...
												(0, h.jsxs)("div", {
													...
													children: [
														...
														(0, h.jsx)("p", {
															...
															children: "Inter-regional exchange tracking",
														}),
													],
												}),
												(0, h.jsx)("div", {
															...
															(0, h.jsxs)("div", {
																...
																children: [
																	...
																	(0, h.jsx)("div", {
																		...
																		children: ["Exchange", "Frequency"].map(
																			function (e) {
																				return (0, h.jsxs)(
																					"label",
																					{
																...
																onClick: function () {
																	window.location.href = ""
																		.concat(
																			...
																			"/GetExchangeDataExcel?startDate=",
																		)
																		.concat(
...
//# sourceMappingURL=28.88dd8783.chunk.js.map
