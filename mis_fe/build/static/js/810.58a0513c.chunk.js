		...
		5810: function (e, n, t) {
			...
			function N() {
				...
				(0, o.useEffect)(
					function () {
						if (
							...
							e.length === J.length &&
								l.Z.post("/MultiGeneratorNames?MultistartDate=" + e, {})
									.then(function (e) {
										return $(e.data);
									})
									.catch(function () {});
						...
						if (me) {
							...
							n.length === me.length &&
								l.Z.post("/MultiGeneratorNames?MultistartDate=" + n, {})
									.then(function (e) {
										return $(e.data);
									})
									.catch(function () {});
				...
				var pn = function (e) {
							...
							if (p) {
								...
								if (h.length > 0) {
									...
									((x["!cols"] = Object.keys(h[0]).map(function (e) {
										...
										y.utils.book_append_sheet(t, x, "Generator Data"));
								}
							} else
								Object.entries(i).forEach(function (e) {
									...
									if (p.length > 0) {
										...
										((u["!cols"] = Object.keys(p[0]).map(function (e) {
											...
											y.utils.book_append_sheet(t, u, i.substring(0, 31)));
									}
								});
					...
					mn = O ? O.length - 1 : 0,
					hn = (ie && ie.length, N && D ? d()(D).diff(d()(N), "days") + 1 : 0),
					xn = Z ? Z.length : 0;
								...
								children: (0, w.jsxs)("div", {
									...
									children: [
										...
										(0, w.jsx)("div", {
											...
											children: "Fetching Generator Data",
										}),
										(0, w.jsx)("div", {
															...
															(0, w.jsxs)("div", {
																...
																children: [
																	...
																	(0, w.jsx)("div", {
																		...
																		children: ["Generator", "Frequency"].map(
																			function (e) {
																				return (0, w.jsxs)(
																					"label",
																					{
																		...
																		(function () {
																			if (J && be) {
																				...
																				e.length &&
																					te &&
																					(l.Z.post(
																						"/GetMultiGeneratorData?MultistartDate="
																							.concat(e, "&MultistationName=")
																							.concat(te, "&Type=Date&time=")
																							.concat(n),
																						{},
																					).then(function (e) {
																						(se(e.data),
					...
					v = (0, o.useMemo)(
						function () {
							...
							for (
								...
								(e.date_time &&
									e.check1 &&
									((M = " \xb7 " + s()(v.Date_Time).format("DD MMM YY")),
									" \u2014 Day-wise"),
									e.date_time &&
										e.check2 &&
										((M = " \xb7 " + s()(v.Date_Time).format("MMM YYYY")),
										" \u2014 Month-wise"));
								var S =
										null !=
										(null === j ||
...
//# sourceMappingURL=810.58a0513c.chunk.js.map
