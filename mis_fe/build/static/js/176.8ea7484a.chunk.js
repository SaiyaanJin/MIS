		...
		176: function (e, n, t) {
			...
			function x(e) {
				var n = (0, g.F)().isDarkMode,
					...
					r = (0, i.useMemo)(
						function () {
							if (!e.isgs_data) return { chartData: {}, chartOptions: {} };
							for (
								var t = e.isgs_data[e.isgs_data.length - 1].Date_Time || [],
									r = (0, m.Jm)(t),
									i = [],
									o = !1,
									s = 0;
								s < e.isgs_data.length - 1;
								s++
							) {
								var l,
									c,
						...
						[e.isgs_data, e.freq_region, e.frequency, e.check1, e.check2, n],
					),
					o = r.chartData,
					s = r.chartOptions;
				return e.isgs_data
				...
				(0, i.useEffect)(
					function () {
						if (
							...
							e.length === J.length &&
								l.Z.post("/MultiIsgsNames?MultistartDate=" + e, {})
									.then(function (e) {
										return $(e.data);
									})
									.catch(function () {});
						...
						if (me) {
							...
							n.length === me.length &&
								l.Z.post("/MultiIsgsNames?MultistartDate=" + n, {})
									.then(function (e) {
										return $(e.data);
									})
									.catch(function () {});
							...
							if (p) {
								...
								if (h.length > 0) {
									...
									((x["!cols"] = Object.keys(h[0]).map(function (e) {
										...
										w.utils.book_append_sheet(t, x, "Isgs Data"));
								}
							} else
												...
												(0, h.jsxs)("div", {
													...
													children: [
														...
														(0, h.jsx)("p", {
															...
															children: "ISGS power monitoring",
														}),
													],
												}),
												(0, h.jsx)("div", {
																		...
																		(function () {
																			if (J && be) {
																				...
																				e.length &&
																					te &&
																					(l.Z.post(
																						"/GetMultiIsgsData?MultistartDate="
...
//# sourceMappingURL=176.8ea7484a.chunk.js.map
