		...
		5924: function (e, n, t) {
			...
			function x(e) {
				var n = (0, g.F)().isDarkMode,
					...
					r = (0, i.useMemo)(
						function () {
							if (!e.ict_data) return { chartData: {}, chartOptions: {} };
							for (
								var t = e.ict_data[e.ict_data.length - 1].Date_Time || [],
									r = (0, m.Jm)(t),
									i = [],
									o = !1,
									l = 0;
								l < e.ict_data.length - 1;
								l++
							) {
								var s,
									c,
									...
									g = p.min,
									h = p.avg,
									x = p.stationName.endsWith("MW"),
									f = m.ko[l % m.ko.length],
									b = x ? "MW" : "MVAR",
									v = "";
								(e.date_time &&
									e.check1 &&
									(v = " \xb7 " + d()(p.Date_Time).format("DD MMM YY")),
									e.date_time &&
										e.check2 &&
										(v = " \xb7 " + d()(p.Date_Time).format("MMM YYYY")));
								var y =
										null !=
										(null === u ||
										void 0 === u ||
									...
									j =
										...
										void 0 === c
											...
											: "N/A",
									k = null != h ? Number(h).toFixed(2) : "N/A";
								i.push({
									label: ""
							...
							if (e.freq_region && e.frequency) {
								var w = (0, m.Rz)(e.freq_region, e.frequency, r);
								w.length && (i.push.apply(i, (0, a.Z)(w)), (o = !0));
							}
							return {
						...
						[e.ict_data, e.freq_region, e.frequency, e.check1, e.check2, n],
					),
					o = r.chartData,
					l = r.chartOptions;
				return e.ict_data
				...
				(0, i.useEffect)(
					function () {
						if (
							...
							e.length === J.length &&
								s.Z.post("/MultiIctNames?MultistartDate=" + e, {})
									.then(function (e) {
										return $(e.data);
									})
									.catch(function () {});
						...
						if (me) {
							...
							n.length === me.length &&
								s.Z.post("/MultiIctNames?MultistartDate=" + n, {})
									.then(function (e) {
										return $(e.data);
									})
									.catch(function () {});
							...
							if (p) {
								...
								if (h.length > 0) {
									...
									((x["!cols"] = Object.keys(h[0]).map(function (e) {
										...
										w.utils.book_append_sheet(t, x, "Ict Data"));
								}
							} else
												...
												(0, h.jsxs)("div", {
													...
													children: [
														...
														(0, h.jsx)("p", {
															...
															children: "ICT Analytics monitoring",
														}),
													],
												}),
												(0, h.jsx)("div", {
...
//# sourceMappingURL=924.94fdef74.chunk.js.map
