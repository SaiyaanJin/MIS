		...
		9292: function (e, n, t) {
			...
			function h(e) {
				var n = (0, g.F)().isDarkMode,
					...
					a = (0, i.useMemo)(
						function () {
							if (!e.frequency_data) return { chartData: {}, chartOptions: {} };
							for (
								var t =
										e.frequency_data[e.frequency_data.length - 1].Date_Time ||
										[],
									a = (0, m.Jm)(t),
									r = [],
									i = 0;
								i < e.frequency_data.length - 1;
								i++
							) {
								var o,
									l,
									s = e.frequency_data[i],
									c = s.max,
									p = s.min,
									u = s.avg,
									g = m.ko[i % m.ko.length],
									x = "";
								(e.date_time &&
									e.check1 &&
									(x = " \xb7 " + d()(s.Date_Time).format("DD MMM YY")),
									e.date_time &&
										e.check2 &&
										(x = " \xb7 " + d()(s.Date_Time).format("MMM YYYY")));
								var h =
										null !=
										(null === c ||
										void 0 === c ||
									...
									f =
										...
										void 0 === l
											? void 0
											: l[0])
											? Number(p[0][0]).toFixed(4)
											: "N/A",
									b = null != u ? Number(u).toFixed(4) : "N/A";
								r.push({
									label: ""
						...
						[e.frequency_data, e.check1, e.check2, n],
					),
					r = a.chartData,
					o = a.chartOptions;
				return e.frequency_data
					? (0, x.jsxs)("div", {
							style: {
								position: "relative",
								width: "100%",
				...
				(0, i.useEffect)(
					function () {
						if (
							...
							e.length === P.length &&
								s.Z.post("/MultiFrequencyNames?MultistartDate=" + e, {})
									.then(function (e) {
										return $(e.data);
									})
									.catch(function () {});
						...
						if (me) {
							...
							n.length === me.length &&
								s.Z.post("/MultiFrequencyNames?MultistartDate=" + n, {})
									.then(function (e) {
										return $(e.data);
									})
									.catch(function () {});
							...
							if (p) {
								...
								if (x.length > 0) {
									...
									((h["!cols"] = Object.keys(x[0]).map(function (e) {
										...
										w.utils.book_append_sheet(t, h, "Frequency Data"));
								}
							} else
								...
								children: (0, x.jsxs)("div", {
									...
									children: [
										...
										(0, x.jsx)("div", {
											...
											children: "Fetching Frequency Data",
										}),
										(0, x.jsx)("div", {
												...
												(0, x.jsxs)("div", {
													...
													children: [
														...
														(0, x.jsx)("p", {
															...
															children: "Hz monitoring & stability tracking",
														}),
													],
												}),
												(0, x.jsx)("div", {
															...
															(0, x.jsxs)("div", {
																...
																children: [
																	...
																	(0, x.jsx)("div", {
																		...
																		children: ["Frequency", "Frequency"].map(
																			function (e) {
																				return (0, x.jsxs)(
																					"label",
																					{
...
//# sourceMappingURL=36.512246ec.chunk.js.map
